...
(function($){
        ...
        'layout': [
            ...
            [
                [
                    ...
                    ['bksp', '8', 8, 3, true], ['space', '32', 32, 12, false], ['clear', '46', 46, 3, false]
                ],
                [
    ...
    function createKeypadContainer(){
        ...
        container.setAttribute('style', 'position:absolute;z-index:1;width:100%');
    ...
    function triggerEnter() {
        ...
        e.which = 13;
        e.keyCode = 13;
        $(activeInput.htmlElem).trigger(e);
    }

    /*
     * create keyboard
     * @param {Number} setcontainer
     */
    ...
    window.jQKeyboard = window.jQKeyboard || {};
    window.jQKeyboard.activateKeypad = activateKeypad;
    window.jQKeyboard.removeKeypad = removeKeypad;
})(jQuery);
